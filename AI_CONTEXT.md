...
Construir una suite completa de extracción, inspección, auditoría, desensamblado e ingeniería inversa de paquetes APK que opere **100% de manera autónoma en un teléfono móvil Android**, sin necesidad de ordenador personal ni ADB.
...
- Prioridad total a la **funcionalidad completa de las dependencias** por encima de optimizaciones agresivas de tamaño final del APK. No usar soluciones recortadas sin dependencias si existen librerías consolidadas de la industria (como `baksmali`, `dexlib2` y `apk-parser`).
